// Split from `client.test.ts` at merge: `V2-P5-020` and `V2-P5-014/015/016` each
// created a file of that name for different functions of the same module -- error
// bodies, `as_of` and the items envelope on one side; parameter repetition, path
// encoding and the listing route on the other. They are kept apart rather than
// concatenated because each carries its own fixture setup, and a hand-merge lost
// one of them once.
