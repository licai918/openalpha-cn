...
KNOWN_QUANTILE_PORTFOLIO_LIMITATIONS: Final[tuple[QuantilePortfolioLimitation, ...]] = (
    QuantilePortfolioLimitation(
        ...
        detail=(
            ...
            "AND revision_time <= as_of predicate, so a residual can be built at a mid-year "
            "as_of and is read back at it. "
            ...
            "collapses to one December instant with nothing in the stored rows saying so. One "
            "refusal outside this module still bounds the schedule: no cross section before "
            "2021-12-13 is assemblable. index_member_all is read one day at a time since "
            "V2-P4-027/V2-P4-028 and states no bound of its own. "
