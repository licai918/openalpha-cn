...
def _two_year_store(tmp_path: Path) -> PanelStore:
    ...
    for year, days in TWO_YEAR_SESSIONS.items():
...
def _two_year_requirement(*years: int) -> ReadinessRequirement:
